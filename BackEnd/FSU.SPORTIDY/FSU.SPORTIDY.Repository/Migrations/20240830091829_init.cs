<<<<<<<< HEAD:BackEnd/FSU.SPORTIDY/FSU.SPORTIDY.Repository/Migrations/20240831162027_init.cs
﻿using System;
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvartarClub = table.Column<string>(type: "varchar(max)", unicode: false, nullable: true),
                    CoverImageClub = table.Column<string>(type: "varchar(max)", unicode: false, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SportID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SportCode = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SportName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SportImage = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
...
>>>>>>>> main:BackEnd/FSU.SPORTIDY/FSU.SPORTIDY.Repository/Migrations/20240830091829_init.cs
